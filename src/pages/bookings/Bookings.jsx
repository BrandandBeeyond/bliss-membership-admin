...
const Bookings = () => {
  ...
  return (
    <>
        ...
        {!selectedBooking ? (
          ...
          <>
            ...
            <div className="flex justify-end gap-3">
              <Button variant="outline" className="text-white"  onClick={closeModal}>
                Cancel
              </Button>
              <Button
                variant="primary"
                onClick={() => {
                  // approveArrival(selectedBooking._id)
                  closeModal();
                }}
              >
                Approve
      ...
      <Modal isOpen={modalType === "reject"} title="Reject Arrival Request" onClose={closeModal}>
          ...
          <input
            ...
            onChange={(e) =>
              setSuggestedDates([e.target.value])
            }
          />
